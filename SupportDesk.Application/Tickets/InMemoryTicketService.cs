...
//     
//     public Task<TicketResponse> CreateTicket(CreateTicketRequest request, Guid userId, CancellationToken cancellationToken)
//     {
...
//     }
//
//     public Task<TicketResponse?> AssignTicket(int ticketId, Guid actorId, AssignTicketRequest request, CancellationToken cancellationToken)
//     {
//         return ChangeTicket(
//             ticketId: ticketId,
//             change: ticket => ticket.AssignTo(request.AgentId, actorId: actorId));
//     }
//
//     public Task<TicketResponse?> StartProgressTicket(int ticketId, Guid actorId, CancellationToken cancellationToken)
//     {
//         return ChangeTicket(
//             ticketId: ticketId,
...
//     }
//
//     public Task<TicketResponse?> ResolveTicket(int ticketId, Guid actorId, ResolveTicketRequest request, CancellationToken cancellationToken)
//     {
//         return ChangeTicket(
//             ticketId: ticketId,
...
//     }
//
//     public Task<TicketResponse?> CloseTicket(int ticketId, Guid actorId, CancellationToken cancellationToken)
//     {
//         return ChangeTicket(
//             ticketId: ticketId,
...
//     }
//
//     public Task<TicketResponse?> CancelTicket(int ticketId, Guid actorId, CancelTicketRequest request, CancellationToken cancellationToken)
//     {
//         return ChangeTicket(
//             ticketId: ticketId,
...
//     }
//
//     public Task<TicketCommentResponse?> AddComment(int ticketId, Guid actorId, AddCommentRequest request, CancellationToken cancellationToken)
//     {
